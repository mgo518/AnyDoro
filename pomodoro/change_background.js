...
function set_background_color(desired_color){
    ...
    body.setAttribute("style", "background-color: " + desired_color)
...
background_4_button.addEventListener("click", function() {set_background_picture("zero_two_4.jpg");});
background_5_button.addEventListener("click", function() {set_background_picture("nature.jpg");});
background_6_button.addEventListener("click", function() {set_background_picture("modern.webp");});